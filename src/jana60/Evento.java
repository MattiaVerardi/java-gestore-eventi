...
/**
 * MILESTONE 1 La consegna è di creare una classe Evento che abbia le seguenti
 * proprietà: - titolo - data - numero di posti totali (cioè la capienza della
 ...
 * non sia già passata e che il numero di posti totali sia un numero positivo.
 ...
 * prenotati. Se l’evento è già passato o non ha più posti disponibili deve
 * sollevare un’eccezione. 2. disdici: riduce di uno i posti prenotati. Se
 * l’evento è già passato o non ci sono prenotazioni deve sollevare
